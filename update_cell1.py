...
new_cell1 = (
    ...
    "#   v18: numpy<2 + bitsandbytes==0.43.3 — fixes two remaining crashes:\n"
    "#     * torch 2.2.2 compiled with NumPy 1.x; NumPy 2.0.2 crashes the kernel\n"
    "#     * bitsandbytes 0.49+ needs torch>=2.3 (is_compiling / _has_xpu attrs)\n"
    "#\n"
    "# GPU COMPATIBILITY:\n"
    ...
    "    'numpy<2',  # torch 2.2.2+cu118 compiled with NumPy 1.x; NumPy 2.0 crashes kernel\n"
    ")\n"
    "_pip(\n"
    "    'accelerate>=0.27.0',\n"
    ...
    "\n"
    "# ── 4. Force-pin numpy==1.26.4 AFTER all other installs ─────────────────────\n"
    "# datasets/pyarrow (step 2) can re-upgrade numpy to 2.x; torch 2.2.2+cu118\n"
    "# was compiled against numpy 1.x (dtype size 96 bytes) and crashes at import\n"
    "# time if numpy 2.x (dtype size 88 bytes) is active. --force-reinstall\n"
    "# overwrites all numpy files regardless of what is currently installed.\n"
    "print('Force-pinning numpy==1.26.4 (--force-reinstall) ...')\n"
    "subprocess.run(\n"
