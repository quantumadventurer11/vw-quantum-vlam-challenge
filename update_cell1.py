...
new_cell1 = (
    ...
    "#   v20: uninstall jax/jaxlib/flax — the REAL fix: transformers.is_flax_available()\n"
    "#        imports jax whose k8s_cluster calls np.random.rand at module load time;\n"
    "#        Kaggle's numpy .so files are system-locked, so any numpy downgrade\n"
    "#        breaks numpy.random; removing JAX stops the import chain entirely\n"
    "#\n"
    "# GPU COMPATIBILITY:\n"
