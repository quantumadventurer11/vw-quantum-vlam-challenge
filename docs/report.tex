...
\textbf{Compressed models} (Phase~3 direct GPU evaluation, 3 seeds $\times$ 50 episodes each):
...
128   & $5881\pm3$ & $+180.6\%$ & $14112$ & $0.2742\pm0.0000$ \\
64   & $5881\pm3$ & $+180.6\%$ & $14112$ & $0.2017\pm0.0000$ \\
32   & $5895\pm3$ & $+181.3\%$ & $14112$ & $0.2320\pm0.0000$ \\
16   & $5888\pm2$ & $+181.0\%$ & $14112$ & $0.2224\pm0.0000$ \\
\bottomrule
\end{tabular}
\par\smallskip
...
Values in rows 2--5 are measured directly via GPU inference (Phase~3).}
\end{table}
...
Compressed model ($\chi=64$): $1.43e-04$\,kWh/sample
($-374\%$ per-sample reduction). The model compression reduces FLOPs but the dominant
...
TN LLM only ($\chi=64$) & $0.2017\pm0.0000$ & $\sim$1.20\,B & --- \\
TN full ($\chi=64$) & $0.2260\pm0.0000$ & $\sim$0.13\,B & $+0.0243$ \\
\bottomrule
\end{tabular}
\par\smallskip
...
Phase 3 GPU-hours & $\sim$1.00\,h (4 $\chi$ $\times$ 3 seeds) \\
